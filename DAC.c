...
void sin(uint8 FTM0_C0SC_counter){
	...
	writeDAC(y_values_for_sine[FTM0_C0SC_counter]);	/**Función para cargar el valor actual al DAC*/

};

void writeDAC(sint8 valor)/** Función utilizada en las anteriores funciones para cargar valores en el DAC*/
{
...
//		writeDAC(ftm0ch0+ftm0ch1+ftm0ch2+ftm0ch3+ftm0ch4+ftm0ch5+ftm0ch6+ftm0ch7+ftm3ch0+ftm3ch1+ftm3ch2+ftm3ch3+ftm3ch4+ftm3ch5+ftm3ch6,ftm3ch7);	/**Función para cargar el valor actual al DAC*/
//	}
//}
